...
export const mockUsers: User[] = [
  {
    ...
    email: 'carlos.silva@bairral.com.br',
    roleId: 'role-admin',
  ...
  },
  {
    ...
    email: 'ana.rocha@bairral.com.br',
    roleId: 'role-gestor',
...
export const mockUnits: Unit[] = [
  {
    id: 'unit-1',
    name: 'Hospital Psiquiátrico Bairral - Sede (Itapira/SP)',
    code: 'HPB-SEDE',
    address: 'Rua Pedro de Paula, 100 - Itapira/SP',
    managerId: 'user-1',
    managerName: 'Carlos Alberto Silva',
    active: true,
  ...
  {
    id: 'unit-2',
    name: 'Unidade Esplanada (Psiquiatria Masculina)',
    code: 'U-ESPLANADA',
    address: 'Rua Pedro de Paula, 100 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
  ...
  {
    id: 'unit-3',
    name: 'Unidade Prédio Central (Psiquiatria Feminina)',
    code: 'U-CENTRAL',
    address: 'Rua Pedro de Paula, 100 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
  ...
  {
    id: 'unit-4',
    name: 'Unidade Mirante (Infantil e Adolescente)',
    code: 'UIA-MIRANTE',
    address: 'Av. dos Pinheirais, 450 - Itapira/SP',
    managerId: 'user-3',
    managerName: 'Dr. Roberto Mendes',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-5',
    name: 'Unidade Vivenda (Dependência Química Masculina)',
    code: 'U-VIVENDA',
    address: 'Alameda das Figueiras, 120 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-6',
    name: 'Unidade Estância (Dependência Química Feminina)',
    code: 'U-ESTANCIA',
    address: 'Alameda das Figueiras, 200 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-7',
    name: 'Unidade Valle Rosa (Geriatria e Cuidados Continuados)',
    code: 'U-VALLE-ROSA',
    address: 'Rodovia SP-352, Km 12 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-8',
    name: 'Centro de Convivência e Reabilitação (CCR)',
    code: 'CCR-BAIRRAL',
    address: 'Estrada Municipal Bairral, s/n - Itapira/SP',
    managerId: 'user-4',
    managerName: 'Ana Paula Rocha',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-9',
    name: 'Ambulatório e Pronto Atendimento Bairral',
    code: 'PA-BAIRRAL',
    address: 'Rua Pedro de Paula, 120 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'unit-10',
    name: 'Sede Administrativa e Operacional Grupo Bairral',
    code: 'ADM-BAIRRAL',
    address: 'Rua Pedro de Paula, 100 - Itapira/SP',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
...
export const mockDepartments: Department[] = [
  {
    id: 'dept-1',
    unitId: 'unit-1',
    name: 'Tecnologia da Informação & Governança',
    code: 'TI-GOV',
    description: 'Gestão de infraestrutura tecnológica e segurança de dados',
    managerId: 'user-1',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'dept-2',
    unitId: 'unit-1',
    name: 'Compliance & Integridade',
    code: 'COMPLIANCE',
    description: 'Gestão do canal de denúncias e programa de integridade',
    managerId: 'user-2',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    id: 'dept-3',
    unitId: 'unit-1',
    name: 'Enfermagem & Assistência Hospitalar',
    code: 'ENFERMAGEM',
    description: 'Equipe de cuidados continuados e enfermagem especializada',
    managerId: 'user-3',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
  },
  {
    ...
    code: 'RH',
    description: 'Gestão de talentos, clima organizacional e departamento pessoal',
    managerId: 'user-4',
    active: true,
    createdAt: '2025-01-01T00:00:00Z',
    updatedAt: '2025-01-01T00:00:00Z',
...
export const mockCategories: Category[] = [
  {
    ...
    code: 'ASSEDIO',
    description: 'Condutas inadequadas que constrangem ou afetam a dignidade do indivíduo no ambiente hospitalar',
...
export const mockSettings = {
  ...
  institutional: {
    ...
    address: 'Rua Pedro de Paula, 100 - Centro - Itapira/SP - CEP 13970-900',
    ethicsEmail: 'canaldeetica@bairral.com.br',
    dpoName: 'Dra. Patricia Medeiros',
    dpoEmail: 'dpo@bairral.com.br',
  },
  slaDefaults: {
  ...
  alternativeChannels: {
    phone0800: '0800 770 1234',
    whatsappNumber: '+55 19 99876-5432',
    physicalBoxLocations: 'Urnas físicas localizadas nas recepções do Pavilhão Central, Mirante e Almoxarifado.',
  },
  notifications: {
