    ...
    <Container size="md" className="py-10 space-y-8">
      ...
      <Surface variant="card" className="space-y-6 text-xs text-[#262626] leading-relaxed">
        ...
        <div className="space-y-2">
          ...
          <p>
            Estes termos são regidos pelas leis da República Federativa do Brasil. Quaisquer disputas relativas ao uso deste portal serão submetidas ao Foro da Comarca de Itapira, Estado de São Paulo.
          </p>
        </div>
      </Surface>
    </Container>
