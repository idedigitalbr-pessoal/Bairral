    ...
    <Container size="md" className="py-10 space-y-8">
      ...
      <Surface variant="card" className="space-y-6 text-xs text-[#262626] leading-relaxed">
        <div className="space-y-2 border-b border-[#F5F5F5] pb-4">
          ...
          <p>
            O Controlador dos Dados Pessoais é a Sociedade Anônima Hospital Bairral de Psiquiatria (Grupo Bairral), com sede na Rua David Campista, 201, Itapira/SP. Esta política se aplica a todos os relatos, documentos e interações realizados através deste Canal de Ética e Integridade.
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p>
            Para exercer seus direitos como titular de dados pessoais (confirmação, acesso, correção ou eliminação) ou esclarecer dúvidas sobre esta política, entre em contato com nosso Encarregado de Proteção de Dados através do e-mail <strong>dpo@bairral.com.br</strong>.
          </p>
        </div>
      </Surface>
    </Container>
