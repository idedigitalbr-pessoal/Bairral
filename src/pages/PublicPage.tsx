    ...
    <div className="space-y-16 pb-16">
        ...
        <div className="bg-[#171717] text-white p-8 rounded border border-[#262626] flex flex-col md:flex-row items-center justify-between gap-6 shadow-md">
          <div className="space-y-3 text-center md:text-left">
            ...
            <h3 className="font-heading text-lg font-bold text-white">
              Tratamento ético e legal de dados pessoais no âmbito hospitalar
            </h3>
            <p className="text-xs text-[#A3A3A3] max-w-2xl leading-relaxed">
              O Grupo Bairral de Psiquiatria atua sob rigoroso cumprimento da Lei Geral de Proteção de Dados (Lei nº 13.709/2018), assegurando a guarda protegida de relatórios e a inviolabilidade da privacidade.
            </p>
          </div>
      ...
      <Container size="lg" className="space-y-6">
        <div className="text-center space-y-1">
          ...
          <p className="text-xs text-[#525252]">
            Caso prefira, você também pode entrar em contato com a Ouvidoria do Grupo Bairral através dos canais institucionais diretos:
          </p>
        </div>
        ...
        <Grid cols={3} gap="4">
          <div className="p-4 bg-white border border-[#E5E5E5] rounded flex items-start gap-3">
            ...
            <div>
              <h5 className="font-heading font-bold text-xs text-[#0A0A0A]">Atendimento Presencial</h5>
              <p className="text-xs text-[#525252] mt-0.5">
                Hospital Bairral de Psiquiatria<br />
                Rua David Campista, 201 — Prados, Itapira/SP
              </p>
            </div>
          </div>
          ...
          <div className="p-4 bg-white border border-[#E5E5E5] rounded flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#525252] mt-0.5">
                ouvidoria@bairral.com.br<br />
                comissao.etica@bairral.com.br
              </p>
            </div>
          </div>
          ...
          <div className="p-4 bg-white border border-[#E5E5E5] rounded flex items-start gap-3">
            ...
            <div>
              <h5 className="font-heading font-bold text-xs text-[#0A0A0A]">Telefone Institucional</h5>
              <p className="text-xs text-[#525252] mt-0.5">
                (19) 3863-9400<br />
