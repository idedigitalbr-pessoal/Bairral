    ...
    <footer className="bg-[#171717] border-t border-[#262626] text-[#A3A3A3] text-xs pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            <h4 className="font-heading text-xs font-bold uppercase tracking-wider text-white">
              Hospital Bairral de Psiquiatria
            </h4>
            <p className="text-xs text-[#A3A3A3] leading-relaxed">
              Rua David Campista, 201 — Bairro Prados<br />
              Itapira / SP — CEP 13970-901
            </p>
            <div className="pt-1">
              <a
                href="https://www.bairral.com.br"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1 text-xs text-[#D4D4D4] hover:text-white underline"
              >
                bairral.com.br <ExternalLink className="w-3 h-3" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#262626] pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[#737373]">
          <p>
            Grupo Bairral de Psiquiatria &copy; {currentYear}. Todos os direitos reservados.
          </p>
