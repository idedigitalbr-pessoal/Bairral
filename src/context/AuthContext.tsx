...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const switchSimulatedUser = useCallback((role: AdminRole) => {
    ...
    const mockEmailMap: Record<AdminRole, string> = {
      [AdminRoleEnum.SUPER_ADMIN]: 'superadmin@bairral.com.br',
      [AdminRoleEnum.ETHICS_MANAGER]: 'gestor.etica@bairral.com.br',
      [AdminRoleEnum.TRIAGE_ANALYST]: 'analista.triagem@bairral.com.br',
      [AdminRoleEnum.INVESTIGATOR]: 'investigador@bairral.com.br',
      [AdminRoleEnum.AREA_RESPONSIBLE]: 'responsavel.area@bairral.com.br',
      [AdminRoleEnum.AUDITOR]: 'auditor@bairral.com.br',
      [AdminRoleEnum.EXECUTIVE_VIEWER]: 'executivo@bairral.com.br',
    };
    ...
    const newUser: AdminUser = {
      ...
      roleName,
      unitId: 'unit-1',
      unitName: 'Hospital Bairral de Psiquiatria - Sede',
      departmentId: 'dept-1',
