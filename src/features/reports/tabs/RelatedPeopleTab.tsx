  ...
  const peopleList: RelatedPerson[] = report.relatedPeople || [
    {
      ...
      department: 'Enfermagem & Assistência Hospitalar',
      involvementType: 'DENOUNCED',
      status: 'PENDING_INTERVIEW',
      notes: 'Citado no relato como responsável direto pela conduta questionada.',
    },
    {
      id: 'p-2',
      ...
      status: 'INTERVIEWED',
      notes: 'Oitiva realizada em 15/01/2026. Prestou esclarecimentos sobre a escala de plantão.',
    },
  ];
